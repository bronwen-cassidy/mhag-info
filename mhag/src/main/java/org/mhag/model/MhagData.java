...
//		genRefSkillClass();
    ...
    public void readSkill(Mhag mhag) {
        ...
        String logLine = String.format("Total Number of Skills : %d", nMax);
        ...
        while (in2.hasNext()) {
            ...
            ioErr = Skill.setSkillFromLine(line, skillList[skillIndex], game);
    ...
    public void readArmor(Mhag mhag) {
        ...
        String logLine = String.format("Total Number of Armors : " + Arrays.toString(nMax));
        MhagUtil.logLine(mhag, logLine);
        in.close();
        ...
        while (in2.hasNext()) {
            ...
            word = Armor.getBodyPartFromLine(line, game);
            nBodyPart = Armor.convertBodyPart(word);
            ioErr = Armor.setArmorFromLine(line, nBodyPart, armorList[nBodyPart][armorIndex[nBodyPart]], game);
    ...
    //get number of charm
    public int getNumCharm() {
        return numCharm;
    }

    public void setNumCharm(int num) {
        numCharm = num;
    }
...
//		indFinal[0] = -1;
    ...
    public String getDirSave(int game) {
        return dirSave[game];
    }

    public int getMaxRank(int game) {
        return maxRank[game];
    }
    ...
    public static int getNMaxCharm() {
        return nMaxCharm;
    }

    public static String getFileCharm() {
        return fileCharm;
    }
