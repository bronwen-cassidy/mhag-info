...
public class Armor {
    ...
    //get armor Total ID
    public static int[] getArmorIDTot() {
        return armorIDTot;
    }

    //get armor Total ID for a part
    public static int getArmorIDTot(int bodyPart) {
        return armorIDTot[bodyPart];
    }
    ...
    // get blader/gunner info
    public int getBG4Head() {
        return bg4Head;
    }

    // get blader/gunner info
    public void setBG4Head(int opt) {
        bg4Head = opt;
    }
    ...
    public void setItem(String entry) {
        items = entry;
    }
