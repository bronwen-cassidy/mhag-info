...
<table>
    <tr>
                        ...
                        <td id="headsourceid">
                            <select name="head" id="headselect" class="setup-select">
                                ...
                                <c:forEach var="hPiece" items="${model.head}">
                                    <option value="<c:out value="${hPiece.armorID}"/>:<c:out value="${hPiece.numSlot}"/>:0:<c:out value="${hPiece.gender}"/>"
                        ...
                        <td id="chestsourceid">
                            <select name="chest" id="chestselect" class="setup-select">
                                ...
                                <c:forEach var="cPiece" items="${model.chest}">
                                    <option value="<c:out value="${cPiece.armorID}"/>:<c:out value="${cPiece.numSlot}"/>:1:<c:out value="${cPiece.gender}"/>"
                        ...
                        <td id="armssourceid">
                            <select name="arms" id="armselect" class="setup-select">
                                ...
                                <c:forEach var="aPiece" items="${model.arms}">
                                    <option value="<c:out value="${aPiece.armorID}"/>:<c:out value="${aPiece.numSlot}"/>:2:<c:out value="${aPiece.gender}"/>"
                        ...
                        <td id="waistsourceid">
                            <select name="waist" id="waistselect" class="setup-select">
                                ...
                                <c:forEach var="wPiece" items="${model.waist}">
                                    <option value="<c:out value="${wPiece.armorID}"/>:<c:out value="${wPiece.numSlot}"/>:3:<c:out value="${wPiece.gender}"/>"
                        ...
                        <td id="legssourceid">
                            <select name="legs" id="legselect" class="setup-select">
                                ...
                                <c:forEach var="lPiece" items="${model.legs}">
                                    <option value="<c:out value="${lPiece.armorID}"/>:<c:out value="${lPiece.numSlot}"/>:4:<c:out value="${lPiece.gender}"/>"
        ...
        <td valign="top">
            <span class="logo"><img class="logo" src="styles/images/MH_logo.png"/></span>
        </td>
    </tr>
</table>